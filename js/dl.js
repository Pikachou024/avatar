...
//     console.log(svg_container)
    ...
    // let download_button = svg_container.querySelector('.buttonRegister');
let download_button = document.querySelector('.buttonRegister');
